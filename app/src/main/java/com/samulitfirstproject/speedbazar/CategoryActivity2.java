...
import com.samulitfirstproject.speedbazar.adapter.CategoryAdapter2;
...
public class CategoryActivity2 extends AppCompatActivity {
    ...
    private CategoryAdapter2 cAdapter;
    private ArrayList<CatInfo> cList;
    private String current_user_id = " ",url,name,category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCat = findViewById(R.id.add_sub_category);
        ...
        productImagesRef = FirebaseStorage.getInstance().getReference().child("Category").child(category);
        CatRef = FirebaseDatabase.getInstance().getReference("Category").child(category);

        loadingBar = new ProgressDialog(CategoryActivity2.this);

        cRecyclerView = findViewById(R.id.add_sub_category_rv);
        ...
        cList = new ArrayList<>();
        cAdapter = new CategoryAdapter2(this, cList);
        ...
        CatRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(CategoryActivity2.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void uploadFile() {
        ...
        if(resultUri==null ) {
            ...
            Toast.makeText(CategoryActivity2.this, "Empty Field!", Toast.LENGTH_SHORT).show();
            loadingBar.dismiss();
        }
    ...
    public void uploadImage(){
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(CategoryActivity2.this, "Sub Category Successfully Added", Toast.LENGTH_SHORT).show();

//                Intent n = new Intent(CategoryActivity2.this,CategoryActivity2.class);
//                startActivity(n);
//                finish();
