...
import com.samulitfirstproject.speedbazar.CategoryActivity2;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.NewsViewHolder> {
    ...
    public CategoryAdapter(Context context, ArrayList<CatInfo> productLists) {
        pContext = context;
    ...
    public void onBindViewHolder(final NewsViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), CategoryActivity2.class);
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        holder.CatRef.child(key).removeValue();
